...
Open the [cycle video](runs/03_reference_chamber/c2_central_fans/videos/c2_202502_cycle.mp4)
or [operating timeseries](runs/03_reference_chamber/c2_central_fans/videos/scenarios_timeseries.mp4).
The owner selected this study on 12 September 2026 as the operating-design reference.
Earlier results are in the local [archive](archive/2026-09-12-other-studies/).

The chamber is **4 × 6 × 3.7 m**, with a 0.6 m elevated floor. Three fans on a
fixed pole beside the trunk blow in directions 120° apart. Cycles have **5 minutes
...
The selected original result stays unchanged; new runs have generic filenames
...
screen fails at about 6.87% spatial variation against a 5% criterion. Conservation
